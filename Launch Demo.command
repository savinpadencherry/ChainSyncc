...
# ChainSync Demo Launcher - Double-click friendly version
# This script can be double-clicked in Finder to start the demo
...
echo -e "${CYAN}🚛 ChainSync AI Logistics Dashboard Demo Launcher${NC}"
echo -e "${CYAN}=================================================${NC}"
echo ""
...
echo -e "${BLUE}🎯 Follow the detailed demo script for best presentation experience${NC}"
echo ""
echo -e "${YELLOW}Close this terminal window or press Ctrl+C to stop the demo${NC}"
echo ""
